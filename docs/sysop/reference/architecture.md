...
* Common use cases: FTN mail polling (binkd), echomail tossing (v3mail), backups, maintenance
...
8. **Built-in FTN Tosser**: Native echomail toss/scan/pack support via `v3mail` without external tools
