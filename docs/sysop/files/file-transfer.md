...
Use the [Configuration Editor](../configuration/configuration.md#configuration-editor-tui) (`./config`, section 9 — Transfer Protocols) to manage protocol definitions interactively. This is the recommended approach.
