...
func evaluateRPN(rpnQueue []token, u *user.User, s ssh.Session, terminal *terminalPkg.BBS, startTime time.Time) (bool, error) {
	var evalStack []bool
...
func checkACS(acsString string, u *user.User, s ssh.Session, terminal *terminalPkg.BBS, startTime time.Time) bool {
...
func evaluateCondition(condition string, u *user.User, s ssh.Session, terminal *terminalPkg.BBS, startTime time.Time) bool {
