...
// Version is the Vision3 version string. Set via build flags:
//
//	-ldflags "-X github.com/user/vision3/internal/jam.Version=1.0.0"
var Version = "0.1.0"
...
func FormatPID() string {
	return fmt.Sprintf("Vision3 %s/%s", Version, runtime.GOOS)
}
