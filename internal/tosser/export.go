...
// Returns 0 if no mark has been recorded yet (normal for new/unscanned areas).
// Logs a warning only for unexpected I/O errors, not for the normal ErrNotFound case.
