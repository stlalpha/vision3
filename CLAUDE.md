...
- **Reference Sources**: Always refer to project documentation, existing code, especially the source `vision-2-bbs/` Turbo Pascal source code which this project is attempting to moderninze with established patterns in the legacy source code before proposing or implementing changes.
