...
Incoming echomail from external tossers (HPT/Husky) is read from JAM and displayed by the message reader. If an origin address is missing from subfields, Vision3 attempts to extract it from the origin line in the text.
